...
from .oci.api import OracleCloudImportStorageListAPI, OracleCloudExportStorageListAPI
...
def get_storage_list():
    return [
        ...
        {'name': 'oci', 'title': 'Oracle Cloud Infra', 'import_list_api': OracleCloudImportStorageListAPI, 'export_list_api': OracleCloudExportStorageListAPI},
    ]